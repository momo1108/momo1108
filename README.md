...
TypeScript, React/Vue 기반의 3년차 프론트엔드 개발자입니다. 

사내 생산성 개선을 위한 운영 도구의 개발을 해왔습니다.

작은 디테일 하나가 전체 서비스에 영향을 미친다는 생각을 가지고 효율적인 코드를
고민하며, 코드를 작성하기 직전에 가장 시간을 많이 들이는 개발자입니다.
